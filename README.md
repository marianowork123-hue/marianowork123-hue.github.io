...
> ⚠️ **Importante sobre el alojamiento.** Esta tienda es una aplicación Next.js con servidor (pagos, login, base de datos). **GitHub Pages NO puede ejecutarla** porque solo sirve archivos estáticos. Súbela a GitHub para guardar el código, pero **publícala en [Vercel](https://vercel.com)** (gratis, 1 clic al importar el repo). Ver el **paso 6**. El workflow opcional en `.github/workflows/deploy-vercel.yml` automatiza ese despliegue.
